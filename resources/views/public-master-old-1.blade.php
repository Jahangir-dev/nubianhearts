...
<body id="page-top" class="lw-page-bg lw-public-master">
    ...
    <div id="wrapper" class="container-fluid">
        ...
        <!-- include sidebar -->
        @if(isLoggedIn() && ($route !== "user.read.find_matches") && ($route !== "user.read.messenger")  && ($route != "user.read.savedSearches") && ($route != "user.read.getSaved") && ($route !="user.read.editSaved") && ($route != "user.read.searchRun")) 
