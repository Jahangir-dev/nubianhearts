...
<div class="card lw-find-form-container mb-4 ">
    <div class="card-body row">
        <div class="col-sm-12 col-md-12 mb-2">
                ...
                <input type="text" name="name" maxlength="10" class="form-control col-md-4" value="">
                 @if($errors->any())
        ...
        <div class="col-md-4 col-sm-12 distance box" @if(isset($inputData['countries__id']) && __isEmpty($inputData['countries__id'])) style="display:block;" @else style="display:none" @endif>
